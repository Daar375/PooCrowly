...
public class HttpRequestor implements IConstants
{
	...
	public static VideoResponse post(String pUrl, String pPayload, String pMSKey)
	{
        ...
        try
        {
            ...
            builder.setParameter("frameSamplingValue", "2");
            /*
	...
	public static VideoResponse get(VideoResponse pVideoResponse, String pMSKey)
	{
        ...
        try
        {
            URIBuilder builder = new URIBuilder(pVideoResponse.getVideoResponseURL()+"/content");
            ...
            if (entity != null) 
            {
                ...
                System.out.println(pVideoResponse.getContent());
                System.out.println();
